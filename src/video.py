...
class Playlist:
    ...
    def __init__(self, playlist_id: str):
        self.__playlist_id: str = playlist_id
        self.pl_summary_info = self.get_service().playlistItems().list(playlistId=self.__playlist_id,
                                                                       part='contentDetails',
                                                                       maxResults=50,
                                                                       ).execute()
    ...
    def get_service(cls):
        ...
        return build(serviceName: 'youtube', version: 'v3', developerKey=os.environ['YT_API_KEY'])
